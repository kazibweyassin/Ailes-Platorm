...
// API route fully commented out to prevent build/export errors. Uncomment when needed.
/*
...
// NOTE: The following handler is temporarily disabled to prevent build errors on Vercel static export.
...
// To re-enable, uncomment the handler above and ensure export errors are resolved.
*/
